...
class Connexions_View_Helper_HtmlUrlItems extends Zend_View_Helper_Abstract
{
    ...
    static public   $styleGroups        = array(
        ...
        self::STYLE_REGULAR => array(
            'label'     => 'Regular',
            'options'   => array('item:stats:rating:stars',
                                 'item:data:itemName',
     ...
     */
    public function htmlUrlItems($paginator    = null,
                                  $viewer       = null,
                                  $tagInfo      = null,
                                  $style        = null,
                                  $sortBy       = null,
...
function init_UrlItems(namespace)
{
    ...
    init_GroupHeader(namespace);
        ...
        if (! @isset(self::$_initialized[$namespace]))
        {
            ...
            // Include required jQuery
            $view->jQuery()->addOnLoad("init_UrlItems('{$namespace}');");
        }
    ...
    protected function _groupValue($groupBy, $value)
    {
        ...
        /*
        Connexions::log(
            sprintf("HtmlUrlItems::_groupValue(%s, %s:%s) == [ %s ]",
