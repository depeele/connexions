if(!this.JSON){this.JSON={}}(function(){function f(n){return n<10?"0"+n:n}if(typeof Date.prototype.toJSON!=="function"){Date.prototype.toJSON=function(key){return isFinite(this.valueOf())?this.getUTCFullYear()+"-"+f(this.getUTCMonth()+1)+"-"+f(this.getUTCDate())+"T"+f(this.getUTCHours())+":"+f(this.getUTCMinutes())+":"+f(this.getUTCSeconds())+"Z":null};String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(key){return this.valueOf()}}var cx=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,escapable=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,gap,indent,meta={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},rep;function quote(string){escapable.lastIndex=0;return escapable.test(string)?'"'+string.replace(escapable,function(a){var c=meta[a];return typeof c==="string"?c:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+string+'"'}function str(key,holder){var i,k,v,length,mind=gap,partial,value=holder[key];if(value&&typeof value==="object"&&typeof value.toJSON==="function"){value=value.toJSON(key)}if(typeof rep==="function"){value=rep.call(holder,key,value)}switch(typeof value){case"string":return quote(value);case"number":return isFinite(value)?String(value):"null";case"boolean":case"null":return String(value);case"object":if(!value){return"null"}gap+=indent;partial=[];if(Object.prototype.toString.apply(value)==="[object Array]"){length=value.length;for(i=0;i<length;i+=1){partial[i]=str(i,value)||"null"}v=partial.length===0?"[]":gap?"[\n"+gap+partial.join(",\n"+gap)+"\n"+mind+"]":"["+partial.join(",")+"]";gap=mind;return v}if(rep&&typeof rep==="object"){length=rep.length;for(i=0;i<length;i+=1){k=rep[i];if(typeof k==="string"){v=str(k,value);if(v){partial.push(quote(k)+(gap?": ":":")+v)}}}}else{for(k in value){if(Object.hasOwnProperty.call(value,k)){v=str(k,value);if(v){partial.push(quote(k)+(gap?": ":":")+v)}}}}v=partial.length===0?"{}":gap?"{\n"+gap+partial.join(",\n"+gap)+"\n"+mind+"}":"{"+partial.join(",")+"}";gap=mind;return v}}if(typeof JSON.stringify!=="function"){JSON.stringify=function(value,replacer,space){var i;gap="";indent="";if(typeof space==="number"){for(i=0;i<space;i+=1){indent+=" "}}else{if(typeof space==="string"){indent=space}}rep=replacer;if(replacer&&typeof replacer!=="function"&&(typeof replacer!=="object"||typeof replacer.length!=="number")){throw new Error("JSON.stringify")}return str("",{"":value})}}if(typeof JSON.parse!=="function"){JSON.parse=function(text,reviver){var j;function walk(holder,key){var k,v,value=holder[key];if(value&&typeof value==="object"){for(k in value){if(Object.hasOwnProperty.call(value,k)){v=walk(value,k);if(v!==undefined){value[k]=v}else{delete value[k]}}}}return reviver.call(holder,key,value)}text=String(text);cx.lastIndex=0;if(cx.test(text)){text=text.replace(cx,function(a){return"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})}if(/^[\],:{}\s]*$/.test(text.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,"]").replace(/(?:^|:|,)(?:\s*\[)+/g,""))){j=eval("("+text+")");return typeof reviver==="function"?walk({"":j},""):j}throw new SyntaxError("JSON.parse")}}}());(function($){function init_log(){$.log=function(fmt){if((window.console!==undefined)&&(window.console.log!==undefined)){var msg=fmt;for(var idex=1;idex<arguments.length;idex++){msg=msg.replace(/%s/,arguments[idex])}window.console.log(msg)}};$.log("Logging enabled")}if((window.console===undefined)||(window.console.log===undefined)){$(document).ready(init_log)}else{init_log()}if($.browser.msie){try{document.execCommand("BackgroundImageCache",false,true)}catch(e){}}$.spawn=function(callback,timeout){setTimeout(callback,(timeout===undefined?0:timeout))};var _jsonRpcId=0;$.jsonRpc=function(def,method,params,options){var rpc={version:def.version,id:_jsonRpcId++,method:method,params:params};options=$.extend({},options,{url:def.target,type:def.transport,dataType:"json",data:JSON.stringify(rpc)});$.ajax(options)};$.validatePasswords=function($active,$pass1,$pass2){var pass1=$pass1.val();var pass2=$pass2.val();var res=true;if((pass1.length<1)||(pass2.length<1)){res=undefined;if($active[0]===$pass1[0]){$pass2.input("valid")}else{$pass1.input("valid")}}else{if(pass1!==pass2){res="Passwords do not match.";if($active[0]===$pass1[0]){$pass2.input("valid",res);res=undefined}else{$pass1.input("valid")}}else{if($active[0]===$pass1[0]){$pass2.input("valid",true)}else{$pass1.input("valid",true)}}}return res};$.ucFirst=function(str){if($.type(str)!=="string"){return str}return str[0].toUpperCase()+str.substr(1)};$.padString=function(str,numChars,padChar){numChars=numChars||2;padChar=padChar||"0";str=""+str;while(str.length<numChars){str=padChar+str}return str};$.esc=function(str){return $.htmlspecialchars(str)};$.summarize=function(text,maxChars){if(maxChars===undefined){maxChars=40}var summary=$.html_entity_decode(text,"ENT_QUOTES");if(summary.length>maxChars){summary=summary.substr(0,maxChars);summary=summary.substr(0,summary.lastIndexOf(" "));summary=summary.replace(/[\s\.\!\?:;\,\-]+$/,"");summary+="..."}summary=$.htmlentities(summary,"ENT_QUOTES");return summary};$.get_html_translation_table=function(table,quote_style){var entities={},hash_map={},decimal=0,symbol="";var constMappingTable={},constMappingQuoteStyle={};var useTable={},useQuoteStyle={};constMappingTable[0]="HTML_SPECIALCHARS";constMappingTable[1]="HTML_ENTITIES";constMappingQuoteStyle[0]="ENT_NOQUOTES";constMappingQuoteStyle[2]="ENT_COMPAT";constMappingQuoteStyle[3]="ENT_QUOTES";useTable=(!isNaN(table)?constMappingTable[table]:(table?table.toUpperCase():"HTML_SPECIALCHARS"));useQuoteStyle=(!isNaN(quote_style)?constMappingQuoteStyle[quote_style]:(quote_style?quote_style.toUpperCase():"ENT_COMPAT"));if((useTable!=="HTML_SPECIALCHARS")&&(useTable!=="HTML_ENTITIES")){throw new Error("Table: "+useTable+" not supported")}entities["38"]="&amp;";if(useTable==="HTML_ENTITIES"){entities["160"]="&nbsp;";entities["161"]="&iexcl;";entities["162"]="&cent;";entities["163"]="&pound;";entities["164"]="&curren;";entities["165"]="&yen;";entities["166"]="&brvbar;";entities["167"]="&sect;";entities["168"]="&uml;";entities["169"]="&copy;";entities["170"]="&ordf;";entities["171"]="&laquo;";entities["172"]="&not;";entities["173"]="&shy;";entities["174"]="&reg;";entities["175"]="&macr;";entities["176"]="&deg;";entities["177"]="&plusmn;";entities["178"]="&sup2;";entities["179"]="&sup3;";entities["180"]="&acute;";entities["181"]="&micro;";entities["182"]="&para;";entities["183"]="&middot;";entities["184"]="&cedil;";entities["185"]="&sup1;";entities["186"]="&ordm;";entities["187"]="&raquo;";entities["188"]="&frac14;";entities["189"]="&frac12;";entities["190"]="&frac34;";entities["191"]="&iquest;";entities["192"]="&Agrave;";entities["193"]="&Aacute;";entities["194"]="&Acirc;";entities["195"]="&Atilde;";entities["196"]="&Auml;";entities["197"]="&Aring;";entities["198"]="&AElig;";entities["199"]="&Ccedil;";entities["200"]="&Egrave;";entities["201"]="&Eacute;";entities["202"]="&Ecirc;";entities["203"]="&Euml;";entities["204"]="&Igrave;";entities["205"]="&Iacute;";entities["206"]="&Icirc;";entities["207"]="&Iuml;";entities["208"]="&ETH;";entities["209"]="&Ntilde;";entities["210"]="&Ograve;";entities["211"]="&Oacute;";entities["212"]="&Ocirc;";entities["213"]="&Otilde;";entities["214"]="&Ouml;";entities["215"]="&times;";entities["216"]="&Oslash;";entities["217"]="&Ugrave;";entities["218"]="&Uacute;";entities["219"]="&Ucirc;";entities["220"]="&Uuml;";entities["221"]="&Yacute;";entities["222"]="&THORN;";entities["223"]="&szlig;";entities["224"]="&agrave;";entities["225"]="&aacute;";entities["226"]="&acirc;";entities["227"]="&atilde;";entities["228"]="&auml;";entities["229"]="&aring;";entities["230"]="&aelig;";entities["231"]="&ccedil;";entities["232"]="&egrave;";entities["233"]="&eacute;";entities["234"]="&ecirc;";entities["235"]="&euml;";entities["236"]="&igrave;";entities["237"]="&iacute;";entities["238"]="&icirc;";entities["239"]="&iuml;";entities["240"]="&eth;";entities["241"]="&ntilde;";entities["242"]="&ograve;";entities["243"]="&oacute;";entities["244"]="&ocirc;";entities["245"]="&otilde;";entities["246"]="&ouml;";entities["247"]="&divide;";entities["248"]="&oslash;";entities["249"]="&ugrave;";entities["250"]="&uacute;";entities["251"]="&ucirc;";entities["252"]="&uuml;";entities["253"]="&yacute;";entities["254"]="&thorn;";entities["255"]="&yuml;"}if(useQuoteStyle!=="ENT_NOQUOTES"){entities["34"]="&quot;"}if(useQuoteStyle==="ENT_QUOTES"){entities["39"]="&#39;"}entities["60"]="&lt;";entities["62"]="&gt;";for(decimal in entities){symbol=String.fromCharCode(decimal);hash_map[symbol]=entities[decimal]}return hash_map};$.htmlentities=function(string,quote_style){var hash_map={},symbol="",tmp_str="",entity="";tmp_str=string.toString();if(false===(hash_map=$.get_html_translation_table("HTML_ENTITIES",quote_style))){return false}hash_map["'"]="&#039;";for(symbol in hash_map){entity=hash_map[symbol];tmp_str=tmp_str.split(symbol).join(entity)}return tmp_str};$.html_entity_decode=function(string,quote_style){var hash_map={},symbol="",tmp_str="",entity="";tmp_str=string.toString();if(false===(hash_map=$.get_html_translation_table("HTML_ENTITIES",quote_style))){return false}delete (hash_map["&"]);hash_map["&"]="&amp;";for(symbol in hash_map){entity=hash_map[symbol];tmp_str=tmp_str.split(entity).join(symbol)}tmp_str=tmp_str.split("&#039;").join("'");return tmp_str};$.htmlspecialchars=function(string,quote_style,charset,double_encode){var optTemp=0,i=0,noquotes=false;if(quote_style===undefined||quote_style===null){quote_style=2}string=string.toString();if(double_encode!==false){string=string.replace(/&/g,"&amp;")}string=string.replace(/</g,"&lt;").replace(/>/g,"&gt;");var OPTS={ENT_NOQUOTES:0,ENT_HTML_QUOTE_SINGLE:1,ENT_HTML_QUOTE_DOUBLE:2,ENT_COMPAT:2,ENT_QUOTES:3,ENT_IGNORE:4};if(quote_style===0){noquotes=true}if(typeof quote_style!=="number"){quote_style=[].concat(quote_style);for(i=0;i<quote_style.length;i++){if(OPTS[quote_style[i]]===0){noquotes=true}else{if(OPTS[quote_style[i]]){optTemp=optTemp|OPTS[quote_style[i]]}}}quote_style=optTemp}if(quote_style&OPTS.ENT_HTML_QUOTE_SINGLE){string=string.replace(/'/g,"&#039;")}if(!noquotes){string=string.replace(/"/g,"&quot;")}return string};$.htmlspecialchars_decode=function(string,quote_style){var optTemp=0,i=0,noquotes=false;if(quote_style===undefined){quote_style=2}string=string.toString().replace(/&lt;/g,"<").replace(/&gt;/g,">");var OPTS={ENT_NOQUOTES:0,ENT_HTML_QUOTE_SINGLE:1,ENT_HTML_QUOTE_DOUBLE:2,ENT_COMPAT:2,ENT_QUOTES:3,ENT_IGNORE:4};if(quote_style===0){noquotes=true}if(typeof quote_style!=="number"){quote_style=[].concat(quote_style);for(i=0;i<quote_style.length;i++){if(OPTS[quote_style[i]]===0){noquotes=true}else{if(OPTS[quote_style[i]]){optTemp=optTemp|OPTS[quote_style[i]]}}}quote_style=optTemp}if(quote_style&OPTS.ENT_HTML_QUOTE_SINGLE){string=string.replace(/&#0*39;/g,"'")}if(!noquotes){string=string.replace(/&quot;/g,'"')}string=string.replace(/&amp;/g,"&");return string};$.date2str=function(date,timeOnly){if((date===undefined)||(!date instanceof Date)){date=new Date()}if(date.getTime()<=0){return"never"}var dateStr="";if(timeOnly!==true){dateStr=date.getFullYear()+"-"+$.padString((date.getMonth()+1))+"-"+$.padString(date.getDate())+" "}var hour=date.getHours();var meridian="am";if(hour===0){hour=12}else{if(hour===12){meridian="pm"}else{if(hour>12){hour-=12;meridian="pm"}}}dateStr+=$.padString(hour,2,"<span style='visibility:hidden;'>1</span>")+":"+$.padString(date.getMinutes())+" "+meridian;return dateStr};$.str2date=function(str){str=""+str;var parts=str.split(" "),dateParts=parts[0].split("-"),timeParts=parts[1].split(":"),date=new Date();dateParts[1]=parseInt(dateParts[1],10);if(dateParts[1]>0){dateParts[1]-=1}date.setUTCFullYear(dateParts[0]);date.setUTCMonth(dateParts[1]);date.setUTCDate(dateParts[2]);date.setUTCHours(timeParts[0]);date.setUTCMinutes(timeParts[1]);date.setUTCSeconds(timeParts[2]);return date};$.spinner=function(state){var $spin=$("#pageHeader h1 a img");if($spin.length>0){var url=$spin.attr("src");if(state===false){if(url.indexOf("-spinner.gif")>0){$spin.attr("src",url.replace("-spinner.gif",".gif"))}}else{if(url.indexOf("-spinner.gif")<0){$spin.attr("src",url.replace(".gif","-spinner.gif"))}}}};$.fn.maxZindex=function(){var maxZ=0;$(this).parents().each(function(){var thisZ=$(this).css("z-index");if(!isNaN(thisZ)){maxZ=Math.max(maxZ,thisZ)}});return maxZ};$.fn.overlay=function(zIndex){return this.each(function(){var $el=$(this);var myZ=(zIndex===undefined?$el.maxZindex():zIndex)+1;var $overlay=$("<div></div>").addClass("ui-widget-overlay").appendTo($el).css({position:"absolute",top:0,left:0,width:$el.outerWidth(),height:$el.outerHeight(),"z-index":myZ});$el.data("connexions-overlay",$overlay)})};$.fn.unoverlay=function(){return this.each(function(){var $el=$(this);var $overlay=$el.data("connexions-overlay");if($overlay&&($overlay.length>0)){$overlay.remove()}})};$.fn.mask=function(){return this.each(function(){$(this).overlay();$.spinner()})};$.fn.unmask=function(){return this.each(function(){$(this).unoverlay();$.spinner(false)})};$.closeAction=function(action,$container){var split=action.indexOf(":");var param=null;if(split<=0){action=action.toLowerCase()}else{param=action.substr(split+1);action=action.substr(0,split).toLowerCase()}switch(action){case"callback":if(param&&param.length){eval(param+"();")}break;case"hide":$container.hide();break;case"iframe":if(window.frameElement&&window.frameElement.close){window.frameElement.close()}break;case"ignore":break;case"close":try{window.close();break}catch(e){}case"reload":window.location.reload();break;case"redirect":case"urlcallback":if(param&&param.length){location.href=param;break}case"back":default:window.history.back();break}};$.changeAutoSignin=function($el){var cookieName=$.registry("api").autoSigninCookie,targetVal=$el.val(),curVal=$.cookie(cookieName),cookieOpts={expires:365,path:$.registry("urls").base},newVal=(curVal?curVal:"");if($el.is(":checked")){if(newVal.length>0){newVal+=","}newVal+=targetVal}else{var re=new RegExp("(s*,s*)?"+targetVal+"(s*,s*)?");newVal=newVal.replace(re,"")}if(newVal.length<1){newVal=null}$.cookie(cookieName,newVal,cookieOpts)};$.spinner();$(window).unload(function(){$.spinner()})}(jQuery));(function(a){a.registry=function(b,c){if(c!==undefined){a.data(document,b,c)}else{return a.data(document,b)}}}(jQuery));jQuery.cookie=function(b,j,m){if(typeof j!=="undefined"){m=m||{};if(j===null){j="";m.expires=-1}var e="";if(m.expires&&(typeof m.expires==="number"||m.expires.toUTCString)){var f;if(typeof m.expires==="number"){f=new Date();f.setTime(f.getTime()+(m.expires*24*60*60*1000))}else{f=m.expires}e="; expires="+f.toUTCString()}if(m.path===undefined){m.path=window.location.pathname}if(m.path&&(m.path.length>1)){m.path=m.path.replace(/\/+$/,"")}if((m.secure===undefined)&&(window.location.protocol.substr(0,5)==="https")){m.secure=true}var l=m.path?"; path="+m.path:"";var g=m.domain?"; domain="+m.domain:"";var a=m.secure?"; secure":"";document.cookie=[b,"=",encodeURIComponent(j),e,l,g,a].join("")}else{var d=null;if(document.cookie&&document.cookie!==""){var k=document.cookie.split(";");for(var h=0;h<k.length;h++){var c=jQuery.trim(k[h]);if(c.substring(0,b.length+1)===(b+"=")){d=decodeURIComponent(c.substring(b.length+1));break}}}return d}};(function(c){var a=c.scrollTo=function(f,e,d){c(window).scrollTo(f,e,d)};a.defaults={axis:"xy",duration:parseFloat(c.fn.jquery)>=1.3?0:1};a.window=function(d){return c(window)._scrollable()};c.fn._scrollable=function(){return this.map(function(){var e=this,d=!e.nodeName||c.inArray(e.nodeName.toLowerCase(),["iframe","#document","html","body"])!=-1;if(!d){return e}var f=(e.contentWindow||e).document||e.ownerDocument||e;return c.browser.safari||f.compatMode=="BackCompat"?f.body:f.documentElement})};c.fn.scrollTo=function(f,e,d){if(typeof e=="object"){d=e;e=0}if(typeof d=="function"){d={onAfter:d}}if(f=="max"){f=9000000000}d=c.extend({},a.defaults,d);e=e||d.speed||d.duration;d.queue=d.queue&&d.axis.length>1;if(d.queue){e/=2}d.offset=b(d.offset);d.over=b(d.over);return this._scrollable().each(function(){var m=this,k=c(m),l=f,j,g={},n=k.is("html,body");switch(typeof l){case"number":case"string":if(/^([+-]=)?\d+(\.\d+)?(px|%)?$/.test(l)){l=b(l);break}l=c(l,this);case"object":if(l.is||l.style){j=(l=c(l)).offset()}}c.each(d.axis.split(""),function(r,s){var t=s=="x"?"Left":"Top",v=t.toLowerCase(),q="scroll"+t,p=m[q],o=a.max(m,s);if(j){g[q]=j[v]+(n?0:p-k.offset()[v]);if(d.margin){g[q]-=parseInt(l.css("margin"+t))||0;g[q]-=parseInt(l.css("border"+t+"Width"))||0}g[q]+=d.offset[v]||0;if(d.over[v]){g[q]+=l[s=="x"?"width":"height"]()*d.over[v]}}else{var u=l[v];g[q]=u.slice&&u.slice(-1)=="%"?parseFloat(u)/100*o:u}if(/^\d+$/.test(g[q])){g[q]=g[q]<=0?0:Math.min(g[q],o)}if(!r&&d.queue){if(p!=g[q]){h(d.onAfterFirst)}delete g[q]}});h(d.onAfter);function h(o){k.animate(g,e,d.easing,o&&function(){o.call(this,f,d)})}}).end()};a.max=function(k,j){var h=j=="x"?"Width":"Height",e="scroll"+h;if(!c(k).is("html,body")){return k[e]-c(k)[h.toLowerCase()]()}var g="client"+h,f=k.ownerDocument.documentElement,d=k.ownerDocument.body;return Math.max(f[e],d[e])-Math.min(f[g],d[g])};function b(d){return typeof d=="object"?d:{top:d,left:d}}})(jQuery);(function(a){jQuery.fn.pngFix=function(d){d=jQuery.extend({blankgif:"blank.gif"},d);var c=(navigator.appName==="Microsoft Internet Explorer"&&parseInt(navigator.appVersion)===4&&navigator.appVersion.indexOf("MSIE 5.5")!==-1);var b=(navigator.appName==="Microsoft Internet Explorer"&&parseInt(navigator.appVersion)===4&&navigator.appVersion.indexOf("MSIE 6.0")!==-1);if(jQuery.browser.msie&&(c||b)){jQuery(this).find("img[src$=.png]").each(function(){jQuery(this).attr("width",jQuery(this).width());jQuery(this).attr("height",jQuery(this).height());var m="";var g="";var f=(jQuery(this).attr("id"))?'id="'+jQuery(this).attr("id")+'" ':"";var n=(jQuery(this).attr("class"))?'class="'+jQuery(this).attr("class")+'" ':"";var j=(jQuery(this).attr("title"))?'title="'+jQuery(this).attr("title")+'" ':"";var k=(jQuery(this).attr("alt"))?'alt="'+jQuery(this).attr("alt")+'" ':"";var h=(jQuery(this).attr("align"))?"float:"+jQuery(this).attr("align")+";":"";var e=(jQuery(this).parent().attr("href"))?"cursor:hand;":"";if(this.style.border){m+="border:"+this.style.border+";";this.style.border=""}if(this.style.padding){m+="padding:"+this.style.padding+";";this.style.padding=""}if(this.style.margin){m+="margin:"+this.style.margin+";";this.style.margin=""}var l=(this.style.cssText);g+="<span "+f+n+j+k;g+='style="position:relative;white-space:pre-line;display:inline-block;background:transparent;'+h+e;g+="width:"+jQuery(this).width()+"px;height:"+jQuery(this).height()+"px;";g+="filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='"+jQuery(this).attr("src")+"', sizingMethod='scale');";g+=l+'"></span>';if(m!==""){g='<span style="position:relative;display:inline-block;'+m+e+"width:"+jQuery(this).width()+"px;height:"+jQuery(this).height()+'px;">'+g+"</span>"}jQuery(this).hide();jQuery(this).after(g)});jQuery(this).find("*").each(function(){var f=jQuery(this).css("background-image");if(f.indexOf(".png")!==-1){var e=f.split('url("')[1].split('")')[0];jQuery(this).css("background-image","none");jQuery(this).get(0).runtimeStyle.filter="progid:DXImageTransform.Microsoft.AlphaImageLoader(src='"+e+"',sizingMethod='scale')"}});jQuery(this).find("input[src$=.png]").each(function(){var e=jQuery(this).attr("src");jQuery(this).get(0).runtimeStyle.filter="progid:DXImageTransform.Microsoft.AlphaImageLoader(src='"+e+"', sizingMethod='scale');";jQuery(this).attr("src",d.blankgif)})}return jQuery}}(jQuery));(function(b){function a(e,d){if(!window.history.pushState){return}e.data("localNavigation.url",d);var c=[];b(window).bind("popstate",function(j){if(c.length<1){return}var h=c.pop();var g=h.context;var f=g.parents(".collapsable:first");b.scrollTo(f,{duration:800,onAfter:function(){f.effect("highlight",null,2000)}})});e.delegate('a[href^="'+d+'"]',"click",function(k){var f=this;var j=b(f);var g=j.attr("href");c.push({context:j});window.history.pushState(null,null,g);g="#"+g.replace(d+"/","").replace(/\//g,"_").toLowerCase();var h=b(g);if(h.length<1){return}h.parents(".collapsable").trigger("expand");h.trigger("expand");var l=window.setInterval(function(){if(!h.is(":visible")){return}window.clearInterval(l);b.scrollTo(h,{duration:800,onAfter:function(){h.parent().effect("highlight",null,2000)}})},250);k.preventDefault();k.stopPropagation();return false})}b.fn.localNavigation=function(c){this.each(function(){a(b(this),c)});return this}}(jQuery));(function(a){a.widget("ui.checkbox",{version:"0.1.2",widgetEventPrefix:"",options:{css:"checkbox",cssOn:"on",cssOff:"off",titleOn:"click to turn off",titleOff:"click to turn on",useElTitle:true,hideLabel:false},_create:function(){var b=this;var d=this.options;d.enabled=b.element.attr("disabled")?false:true;d.checked=b.element.attr("checked")?true:false;d.title="";b.element.data("value.uicheckbox",d.checked);var c=b.element.attr("name");var f=b.element.attr("id");b.$label=false;if(f){b.$label=a("label[for="+f+"]")}if(((!b.$label)||(b.$label.length<1))&&c){b.$label=a("label[for="+c+"]")}if(d.useElTitle===true){d.title=b.element.attr("title");if(((!d.title)||(d.title.length<1))&&(b.$label.length>0)){d.title=b.$label.text()}}var e=d.title+(d.checked?d.titleOn:d.titleOff);b.$el=a('<span class="checkbox"><div class="'+d.css+(d.enabled?" ":" diabled ")+(d.checked?d.cssOn:d.cssOff)+'"'+(e&&e.length>0?' title="'+e+'"':"")+">&nbsp;</div></span>");b.img=b.$el.find("div");b.$el.insertAfter(b.element);b.element.hide();b.$value=a('<input type="hidden" '+(f?'id="'+f+'" ':"")+'name="'+c+'" />');b.$value.attr("value",d.checked);b.$value.insertBefore(b.$el);if(b.$label&&(b.$label.length>0)){if(d.hideLabel===true){b.$label.hide()}else{b.$label.click(function(g){g.preventDefault();g.stopPropagation();b.$el.trigger("click",[g]);return false})}}b._bindEvents()},_bindEvents:function(){var d=this;var c=function(h){if(d.options.enabled===true){d.$el.addClass("ui-state-hover")}};var g=function(h){d.$el.removeClass("ui-state-hover")};var f=function(h){if(d.options.enabled===true){d.$el.addClass("ui-state-focus")}};var e=function(h){d.$el.removeClass("ui-state-focus")};var b=function(h){d.toggle()};d.$el.bind("mouseenter.uicheckbox",c).bind("mouseleave.uicheckbox",g).bind("focus.uicheckbox",f).bind("blur.uicheckbox",e).bind("click.uicheckbox",b)},isChecked:function(){return this.options.checked},isEnabled:function(){return this.options.enabled},enable:function(){var b=this;var c=b.options;if(!c.enabled){c.enabled=true;b.$el.removeClass("ui-state-disabled");b.$el.parent().removeClass("ui-state-disabled");var d=c.title+(c.checked?c.titleOn:c.titleOff);b.img.attr("title",d);b._trigger("enabled")}},disable:function(){var b=this;var c=b.options;if(c.enabled){c.enabled=false;b.$el.addClass("ui-state-disabled");b.$el.parent().addClass("ui-state-disabled");b.img.removeAttr("title");b._trigger("disabled")}},toggle:function(){if(this.options.checked){this.uncheck()}else{this.check()}},check:function(){if(!this.options.checked){this.options.checked=true;this.$value.attr("value",this.options.checked);this.img.removeClass(this.options.cssOff).addClass(this.options.cssOn).attr("title",this.options.title+this.options.titleOn);this._trigger("change",null,"check")}},uncheck:function(){if(this.options.checked){this.options.checked=false;this.$value.attr("value",this.options.checked);this.img.removeClass(this.options.cssOn).addClass(this.options.cssOff).attr("title",this.options.title+this.options.titleOff);this._trigger("change",null,"uncheck")}},reset:function(){if(this.element.data("value.uicheckbox")){this.check()}else{this.uncheck()}},hasChanged:function(){return(this.options.checked!==this.element.data("value.uicheckbox"))},destroy:function(){if(this.$label){this.$label.show()}this.$el.unbind(".uicheckbox");this.$value.remove();this.$el.remove();this.element.show()}})}(jQuery));(function(a){a.widget("ui.input",{version:"0.1.1",widgetEventPrefix:"",options:{priority:"normal",$label:null,hideLabel:true,handleAutofill:false,$validation:null,validation:null},_init:function(){var b=this;var c=this.options;b.saved(true);c.enabled=b.element.attr("disabled")?false:true;if(c.$validation){if(c.$validation.jquery===undefined){c.$validation=a(c.$validation)}}else{c.$validation=b.element.parent().find(".ui-field-status:first")}if((!c.validation)&&(b.element.hasClass("required"))){c.validation="!empty"}b.element.addClass("ui-input ui-corner-all ");b.keyTimer=null;if(c.priority==="primary"){b.element.addClass("ui-priority-primary")}else{if(c.priority==="secondary"){b.element.addClass("ui-priority-secondary")}}b.element.addClass("ui-state-default");if(!c.enabled){b.element.addClass("ui-state-disabled")}var d=b.element.attr("id");if((d===undefined)||(d.length<1)){d=b.element.attr("name")}if((d!==undefined)&&(d.length>0)){c.$label=b.element.parent().find("label[for="+d+"]")}else{c.$label=b.element.closest("label")}if(c.hideLabel===true){c.$label.addClass("ui-input-over").hide()}else{c.$label.addClass("ui-input-over").show()}this._bindEvents()},_bindEvents:function(){var d=this;var e=d.options;var c=function(k){if(d.options.enabled===true){d.element.addClass("ui-state-hover")}};var h=function(l){var k=a(this);k.removeClass("ui-state-hover")};var b=function(k){if(d.options.enabled!==true){return}if(d.keyTimer!==null){clearTimeout(d.keyTimer)}if(k.keyCode===9){return}d.valid(undefined);d.keyTimer=setTimeout(function(){d.validate()},1000)};var g=function(k){if(d.options.enabled===true){if(e.hideLabel===true){e.$label.hide()}d.element.removeClass("ui-state-empty").addClass("ui-state-focus ui-state-active")}};var f=function(k){d._blur()};var j=function(k){d.validate()};d.element.bind("mouseenter.uiinput",c).bind("mouseleave.uiinput",h).bind("keydown.uiinput",b).bind("focus.uiinput",g).bind("blur.uiinput",f).bind("change.uiinput",f).bind("validate.uiinput",j);e.$label.bind("click.uiinput",function(){d.element.focus()});if(d.val()!==""){d.validate()}else{if(e.hideLabel===true){e.$label.show()}}if(e.handleAutofill===true){d._handleAutofill()}},_handleAutofill:function(){var b=this;var d=1;var c=function(){if(b.hasChanged()){a.log("ui.input: id[ %s ] unannounced change after %sms!",b.element.attr("name"),d);b._blur()}else{if(d<10000){d*=10;a.log("ui.input: id[ %s ] wait for %sms for a change...",b.element.attr("name"),d);window.setTimeout(function(){c()},d)}else{a.log("ui.input: id[ %s ] NO change after %sms",b.element.attr("name"),d)}}};c()},_blur:function(){var b=this;var c=b.options;b.element.removeClass("ui-state-focus ui-state-active");if(!b.element.hasClass("ui-state-valid")){b.validate()}if(b.val()===""){b.element.addClass("ui-state-empty");if(c.hideLabel===true){c.$label.show()}}else{if(c.hideLabel===true){c.$label.hide()}b.element.removeClass("ui-state-empty")}},isEnabled:function(){return this.options.enabled},isValid:function(){return this.options.valid},enable:function(){if(!this.options.enabled){this.options.enabled=true;this.element.removeClass("ui-state-disabled").removeAttr("disabled");this.options.$label.removeClass("ui-state-disabled").removeAttr("disabled");try{this._trigger("enabled")}catch(b){}}},disable:function(){if(this.options.enabled){this.options.enabled=false;this.element.attr("disabled",true).addClass("ui-state-disabled");this.options.$label.attr("disabled",true).addClass("ui-state-disabled");try{this._trigger("disabled")}catch(b){}}},reset:function(){this.val(this.element.data("value.uiinput"));this.element.removeClass("ui-state-error ui-state-valid ui-state-changed");this._blur();this.element.removeClass("ui-state-error ui-state-valid ui-state-changed")},hasChanged:function(){return(this.val()!==this.element.data("value.uiinput"))},valid:function(d){var b=this;var c=this.options;if(d===c.valid){return}b.element.removeClass("ui-state-error ui-state-valid ui-state-changed");var g=(c.$validation.length>0);if(g){c.$validation.html("&nbsp;").removeClass("ui-state-invalid ui-state-valid")}if(d===true){b.element.addClass("ui-state-valid");if(g){c.$validation.addClass("ui-state-valid")}}else{if(d!==undefined){b.element.addClass("ui-state-error");if(g){c.$validation.addClass("ui-state-invalid");if(typeof d==="string"){c.$validation.html(d)}}}}if(b.hasChanged()){b.element.addClass("ui-state-changed")}c.valid=d;if(d!==undefined){try{b._trigger("validation_change",null,[d])}catch(f){}}},getLabel:function(){return this.options.$label.text()},setLabel:function(b){this.options.$label.text(b)},getOrigValue:function(){return this.element.data("value.uiinput")},saved:function(b){this.element.data("value.uiinput",this.val());if(b!==true){this.options.valid=undefined;this.validate()}},val:function(c){if(c!==undefined){c=a.trim(c);this.element.removeClass("ui-state-valid");delete this.options.valid;var b=this.element.val(c);this._blur();return b}return a.trim(this.element.val())},validate:function(){var d=[];var c;if(this.options.validation===null){this.valid(true);return}if(a.isFunction(this.options.validation)){var b=this.options.validation.apply(this.element,[this.val()]);if(typeof b==="string"){c=false;d.push(b)}else{c=b}}else{if(this.options.validation==="!empty"){c=((this.val().length>0)?true:false);if(!c){d.push("Cannot be empty")}}}this.valid(((c===false)&&(d.length>0)?d.join("<br />"):c))},destroy:function(){this.options.$validation.removeClass("ui-state-valid ui-state-invalid ");this.options.$label.unbind(".uiinput");this.element.removeClass("ui-state-default ui-state-disabled ui-state-hover ui-state-valid ui-state-error ui-state-focus ui-state-active ui-priority-primary ui-priority-secondary ").unbind(".uiinput").removeData(".uiinput")}})}(jQuery));(function(a){a.widget("ui.tagInput",a.ui.input,{version:"0.0.3",options:{separator:",",unique:true,addOnEnter:true,height:"height",width:"cssWidth",cssClass:{container:"tagInput ui-corner-all ui-state-default",origInput:"rawInput",list:"tagList",item:"tag",remove:"delete",activeInput:"activeInput",measure:"measureInput"},autocomplete:false},_init:function(){var b=this;var c=b.options;b.trimRe=new RegExp("^\\s+|\\s+$","g");b.sepRe=new RegExp("\\s*"+c.separator+"\\s*");c.tags=[];c.tagStr="";b.$container=a("<div />").addClass(c.cssClass.container).addClass(b.element.attr("class")).insertBefore(b.element);b.$label=b.element.siblings("label").appendTo(b.$container);b.$tags=a("<ul/>").addClass(c.cssClass.list).appendTo(b.$container);b._resize();b.tabIndex=b.element.attr("tabIndex");b.element.hide();b.$inputLi=a("<li/>").addClass(c.cssClass.activeInput).appendTo(b.$tags);b.$input=a('<input type="text" />').appendTo(b.$inputLi);if(b.tabIndex){b.$input.attr("tabIndex",b.tabIndex)}b.$measure=a("<div />").addClass(c.cssClass.measure).appendTo(b.$inputLi);b.mWidth=b.$measure.html("m").width()+2;b.$measure.html("");b.$input.width(b.mWidth);b.$inputLi.hide();b._setupAutocomplete();b.origValue=b.element.val();b.val(b.origValue);a.ui.input.prototype._init.apply(this,arguments)},_resize:function(){var c=this;var e=c.options;var d=(e.width==="cssWidth"?c.element.css("width"):c.element.innerWidth());var b=(e.height==="cssHeight"?c.element.css("height"):c.element.innerHeight());if((e.width!=="none")&&d){c.$container.css((e.width==="min-width"?"min-width":"width"),d)}if((e.height!=="none")&&b){c.$tags.css((e.height==="min-height"?"min-height":"height"),b)}return},_setupAutocomplete:function(){var b=this;var c=b.options;if(!c.autocomplete){return}var d=(c.autocomplete!==true?c.autocomplete:{});d.position=a.extend({my:"left top",at:"left bottom",collision:"none",of:b.$inputLi},(d.position===undefined?{}:d.position));d.select=function(g,f){b.$input.val(f.item.value);b.$input.trigger("resize").focus();if(d.addOnSelect!==false){setTimeout(function(){b._squelchBlur=false;b.$input.blur();b.element.focus()},10)}};d.focus=function(g,f){b._squelchBlur=true};b.$input.autocomplete(d)},_bindEvents:function(){var k=this;var b=k.options;var j=a.ui.keyCode;var c=function(m){k.element.focus()};var e=function(m){m.preventDefault();m.stopPropagation();m.stopImmediatePropagation();k._squelchBlur=false;k._activeInput_show()};var h=function(){var n=k.$input.val();k.$measure.html(n);var m=k.$measure.width()+k.mWidth;k.$input.width(m)};var g=function(m){h();k._squelchBlur=false};var d=function(o){h();var n=o.keyCode||o.which;var p=k.$input.val().replace(k.trimRe,"");if(p.length<1){var m=true;k._squelchBlur=true;switch(n){case j.BACKSPACE:k.$inputLi.prev().remove();k._updateTags();break;case j.DELETE:k.$inputLi.prev().remove();k._updateTags();break;case j.LEFT:case j.UP:k.$inputLi.prev().before(k.$inputLi);k.$input.focus();break;case j.RIGHT:case j.DOWN:k.$inputLi.next().after(k.$inputLi);k.$input.focus();break;default:m=false}if(m){o.preventDefault();return false}}};var f=function(n){var m=n.keyCode||n.which;var o=k.$input.val().replace(k.trimRe,"");if((String.fromCharCode(m)===b.separator)||(m===b.separator)||(b.addOnEnter&&(m===j.ENTER))){if((!k.addTag())&&(m===j.ENTER)){k.element.trigger(n)}n.preventDefault();return false}};var l=function(m){if(k._squelchBlur===true){k._squelchBlur=false;m.preventDefault();m.stopPropagation();m.stopImmediatePropagation();k.$input.focus();return false}k.addTag();k._activeInput_hide()};k.element.bind("focus.uitaginput",e);k.$container.bind("click.uitaginput",c);k.$tags.delegate(".activeInput","keydown.uitaginput",d).delegate(".activeInput","keyup.uitaginput",g).delegate(".activeInput","keypress.uitaginput",f).delegate(".activeInput","blur.uitaginput",l).delegate(".activeInput","resize.uitaginput",h);a.ui.input.prototype._bindEvents.apply(this,arguments)},_activeInput_show:function(){var b=this;var c=b.options;if(c.enabled){b.$label.hide();b.$inputLi.show();if(b.mWidth<3){b.mWidth=b.$measure.html("m").width()+2;b.$measure.html("")}b.$container.addClass("ui-state-focus ui-state-active");b.$input.focus()}return this},_activeInput_hide:function(){this.$inputLi.hide();this.$container.removeClass("ui-state-focus ui-state-active");if(this.options.tagStr.length<1){this.$label.show()}return this},_createTag:function(b){var e=this;var g=e.options;var h=b.replace(e.trimRe,"");if((h.length<1)||(g.unique&&(a.inArray(h,g.tags)>-1))){if((h.length>0)&&e.$tags.effect){var d=e.$tags.find("."+g.cssClass.item+" span:contains("+h+")");d.parent().effect("highlight")}return}var d=a("<li />").addClass(g.cssClass.item);var c=a("<span />").text(h).appendTo(d);var f=a("<a />").addClass(g.cssClass.remove+" ui-icon ui-icon-close").html("&nbsp;").appendTo(d).click(function(j){j.preventDefault();d.remove();e._updateTags()});e.$tags.append(d);return d},_updateTags:function(){var b=this;var c=b.options;c.tags=[];b.$tags.find("."+c.cssClass.item+" > span").each(function(){c.tags.push(a(this).html())});c.tagStr=c.tags.join(c.separator);b.element.val(c.tagStr);if((!b.$inputLi.is(":visible"))&&(c.tags.length<1)){b.$label.show()}else{if(c.tags.length>0){b.$label.hide()}}b.element.trigger("validate");b._trigger("change")},addTag:function(e){var c=this;var d=c.options;if(e===undefined){e=(c.$input?a.trim(c.$input.val()):"");c.$measure.html("");c.$input.val("").width(c.mWidth)}var b=c._createTag(e);if(b){c.$input.closest("li").before(b);c.$input.focus();c._updateTags()}return(b?true:false)},deleteTag:function(d){var b=this;var c=b.options;var e=a.inArray(d,c.tags);if(e<0){return this}b.$tags.find("."+c.cssClass.item).eq(e).remove();b._updateTags()},enable:function(){if(!this.options.enabled){this.options.enabled=true;this.$container.removeClass("ui-state-disabled").removeAttr("disabled");this.$label.removeClass("ui-state-disabled").removeAttr("disabled");this._trigger("enabled")}return this},disable:function(){var b=this.options;if(b.enabled){b.enabled=false;this.$container.attr("disabled",true).addClass("ui-state-disabled");this.$label.attr("disabled",true).addClass("ui-state-disabled");if(this.$inputLi.is(":visible")){this._squelchBlur=true;this._activeInput_hide();this._squelchBlur=false}this._trigger("disabled")}return this},reset:function(){this.val(this.origValue);this.$container.removeClass("ui-state-error ui-state-valid ui-state-changed");return this},hasChanged:function(){return(this.val()!==this.origValue)},option:function(c,d){if((c===undefined)||(d!==undefined)||(typeof c!=="string")){return a.ui.input.prototype.option.apply(this,arguments)}var b;switch(c){case"term":b=this.term();break;default:b=this.options[c];break}return b},term:function(){var b=this;var c=b.options;var d="";if(b.$inputLi.is(":visible")){d=b.$input.val()}return d},val:function(d){var b=this;var e=b.options;if(d!==undefined){b.element.removeClass("ui-state-valid");delete b.options.valid;var c=a.trim(d).split(b.sepRe);e.tags=[];e.tagStr="";b.$tags.find(".tag").remove();a.each(c,function(){b.addTag(this)});e.tags=c;e.tagStr=e.tags.join(e.separator);b.element.val(e.tagStr)}return e.tagStr},destroy:function(){var b=this;var c=b.options;b.element.unbind(".uitaginput");b.$tags.undelegate("input",".uitaginput");b.$container.unbind(".uitaginput");b.$label.insertBefore(b.element).show();b.element.show();b.$container.remove();a.ui.input.prototype.destroy.apply(this,arguments)}})}(jQuery));
/*
